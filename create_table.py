...
conn.execute('CREATE TABLE IF NOT EXISTS menus (id INTEGER PRIMARY KEY, title VARCHAR, price FLOAT, description TEXT, restaurant_id INTEGER, food_type_id INTEGER, created_at TIMESTAMP, FOREIGN KEY (restaurant_id) REFERENCES restaurants(id), FOREIGN KEY (food_type_id) REFERENCES restaurant_type(id))')
